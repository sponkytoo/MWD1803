...
void __ISR(_SPI1_RX_VECTOR, ipl1AUTO) _IntHandlerSPIRxInstance1(void)
{
    DRV_SPI_Tasks(sysObj.spiObjectIdx1);
}
void __ISR(_SPI1_TX_VECTOR, ipl1AUTO) _IntHandlerSPITxInstance1(void)
{
    DRV_SPI_Tasks(sysObj.spiObjectIdx1);
}
void __ISR(_SPI1_FAULT_VECTOR, ipl1AUTO) _IntHandlerSPIFaultInstance1(void)
{
    DRV_SPI_Tasks(sysObj.spiObjectIdx1);
}
